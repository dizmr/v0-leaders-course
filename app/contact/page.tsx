    ...
    <div className="overflow-hidden">
      ...
      <section className="py-20 lg:py-28 px-4 sm:px-6 lg:px-8 bg-secondary/30 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-foreground mb-6">Контакты</h1>
      ...
      <section className="py-20 lg:py-28 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
            {/* Form */}
            <div className="bg-card p-6 lg:p-10 rounded-2xl border border-border shadow-soft">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-3.5 rounded-xl border border-border bg-background focus:outline-none focus:border-accent focus:ring-2 focus:ring-accent/20 transition-all"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    rows={5}
                    className="w-full px-4 py-3.5 rounded-xl border border-border bg-background focus:outline-none focus:border-accent focus:ring-2 focus:ring-accent/20 transition-all resize-none"
            ...
            <div className="space-y-6">
              {/* Quick Contact */}
              <div className="bg-card p-6 lg:p-8 rounded-2xl border border-border shadow-soft">
                <h3 className="text-xl font-semibold text-foreground mb-6">Быстрая связь</h3>
                <div className="space-y-4">
                  <a
                    href="mailto:support@leaders-course.com"
                    className="flex items-center gap-4 p-4 rounded-xl bg-secondary/50 hover:bg-accent/10 transition-colors group"
                  >
